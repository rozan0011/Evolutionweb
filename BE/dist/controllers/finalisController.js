...
var finalisModel_1 = require("../models/finalisModel");
var getAllFinalisController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var finalis, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, finalisModel_1.getAllFinalis)()];
            case 1:
                finalis = _a.sent();
                res.json(finalis);
                return [3 /*break*/, 3];
