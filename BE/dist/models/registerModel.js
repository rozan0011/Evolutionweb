...
const checkEmail = (Email) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE Email = ?", [Email]);
...
const checkNamaTeam = (Nama_Team) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE Nama_Team = ?", [Nama_Team]);
    if (dataRegister.length > 0) {
        return 401;
    }
    else {
...
const checkNIM = (Nomor_Induk_Mahasiswa) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE Nomor_Induk_Mahasiswa = ?", [Nomor_Induk_Mahasiswa]);
    if (dataRegister.length > 0) {
        return 401;
    }
    else {
...
const checkNomorTelfon = (Nomor_Telfon) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE Nomor_Telfon = ?", [Nomor_Telfon]);
    if (dataRegister.length > 0) {
        return 401;
    }
    else {
...
const checkNama = (Nama) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE Nama = ?", [Nama]);
    if (dataRegister.length > 0) {
        return 401;
    }
    else {
...
const checkStatusRegistrasiWithExpectedStatus = (RegistrationID, expect_status) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT Status_Registrasi FROM Register WHERE RegistrationID = ?", [RegistrationID]);
    if (dataRegister.length > 0) {
...
const changeStatusRegistrasi = (RegistrationID, newStatus) => __awaiter(void 0, void 0, void 0, function* () {
    yield db_1.DBconnection.query("UPDATE Register SET Status_Registrasi = ? WHERE RegistrationID = ?", [newStatus, RegistrationID]);
});
exports.changeStatusRegistrasi = changeStatusRegistrasi;
// fungsi untuk input data registrasi
const createRegister = (newRegister) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db_1.DBconnection.query(`INSERT INTO Register 
    ...
    yield db_1.DBconnection.query(`INSERT INTO Team (TeamID,RegistrationID,Nama_Anggota1,NIM_Anggota1) VALUES (?,?,?,?)`, [
    ...
    if (Competitions) {
        yield db_1.DBconnection.query("INSERT INTO Competitions (CompetitionsID, RegistrationID, Pernyataan_Origalitas, Proposal, Dokumen_Substansi, title) VALUES (?, ?, ?,?, ?, ?)", [
            (0, generateID_1.generateID)(),
            newRegister.RegistrationID,
            "",
            "",
    ...
    yield db_1.DBconnection.query(`INSERT INTO Administrative 
...
const login = (Email, Password) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE Email = ? AND Password = ?", [Email, Password]);
        if (dataRegister.length > 0) {
            ...
            yield db_1.DBconnection.query("UPDATE Register SET token = ? WHERE RegistrationID = ?", [token, dataRegister[0].RegistrationID]);
...
exports.login = login;
// logout
const logout = (RegistrationID) => __awaiter(void 0, void 0, void 0, function* () {
    yield db_1.DBconnection.query("UPDATE Register SET token = ? WHERE RegistrationID = ?", [null, RegistrationID]);
});
exports.logout = logout;
// fungsi untuk cek status registrasi yang mertun string status_registrasi ("sudah" atau "belum")
const checkStatusRegistrasi = (RegistrationID) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT Status_Registrasi FROM Register WHERE RegistrationID = ?", [RegistrationID]);
    if (dataRegister.length > 0) {
...
// admin
const getAllRegisters = () => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register");
    return dataRegister;
});
exports.getAllRegisters = getAllRegisters;
const getSingleRegister = (RegistrationID) => __awaiter(void 0, void 0, void 0, function* () {
    const [dataRegister] = yield db_1.DBconnection.query("SELECT * FROM Register WHERE RegistrationID = ?", [RegistrationID]);
    if (dataRegister.length > 0) {
        return dataRegister[0];
    }
    else {
...
const updateRegister = (RegistrationID, updatedRegister) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db_1.DBconnection.query(`UPDATE Register SET 
    Nama = COALESCE(?, Nama),
...
const deleteRegister = (RegistrationID) => __awaiter(void 0, void 0, void 0, function* () {
    yield db_1.DBconnection.query("DELETE FROM Register WHERE RegistrationID = ?", [
        RegistrationID,
    ]);
});
