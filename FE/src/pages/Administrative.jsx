...
const Administrative = () => {
    ...
    const checkRegistrationStatus = async () => {
        ...
        try {
            ...
            console.log("Registration Status Response:", result); // Log the response

            if (response.ok) {
                setIsRegistered(result.exists);
            } else {
                console.error("Error checking registration status:", result.message);
            }
        } catch (error) {
            console.error("Error during registration status check:", error);
        }
    };
            ...
            <div className="container mt-5">
                ...
                {isLoading ? (
                    ...
                    <div className="alert alert-success text-white bg-[#222725] p-4 rounded-md">
                        Anda sudah Mengumpulkan. Anda tidak bisa mengunggah dokumen lagi. Jika ada kendala harap hubungi panitia melalui contact person.
                    </div>
                ) : (
                ...
                <form
                    ...
                    class="p-4 shadow-sm rounded-md bg-light bg-[#222725] mt-4">
